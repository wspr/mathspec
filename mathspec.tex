...
\setmathrm{LibreBaskerville-Regular.otf}
...
\begin{table}
\begin{tabular}{@{}rl@{}}\topbottomrule
Text & \fontspec{LibreBaskerville-Italic.otf} abcdefghijklmnopqrstuvwxyz\\
Mathematics & $\"abcdefghijklmnopqrstuvwxyz"$\\\bottomrule
\end{tabular}
\caption{Libre Baskerville \acr{MT} in text and spaced mathematics.\label{tab:stix}}
\end{table}
